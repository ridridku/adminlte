<script type="text/javascript">
  ...
  //data ecommmerce
  function tampilEcommerce() {
		$.get('<?php echo base_url('Ecommerce/tampil'); ?>', function(data) {
			MyTable.fnDestroy();
			$('#data-ecom').html(data);
			refresh();
		});
	...
	var ORDER_SN;
	$(document).on("click", ".konfirmasiHapus-Ecom", function() {
		ORDER_SN = $(this).attr("data-id");
	})
	$(document).on("click", ".hapus-dataEcom", function() {
		var id = ORDER_SN;
		alert(ORDER_SN);
		$.ajax({
			method: "POST",
			url: "<?php echo base_url('Ecommerce/delete'); ?>",
			data: "id=" +id
		})
		.done(function(data) {
			$('#konfirmasiHapus').modal('hide');
...
//
//	$(document).on("click", ".update-dataEcommerce", function() {
//		var id = $(this).attr("data-id");
//		
//		$.ajax({
//			method: "POST",
//			url: "<?php //echo base_url('Ecommerce/update'); ?>",
//			data: "id=" +id
//		})
//		.done(function(data) {
//			$('#tempat-modal').html(data);
...
//	})
//
//	$(document).on("click", ".detail-dataEcommerce", function() {
//		var id = $(this).attr("data-id");
//		
//		$.ajax({
//			method: "POST",
//			url: "<?php //echo base_url('Ecommerce/detail'); ?>",
//			data: "id=" +id
//		})
//		.done(function(data) {
//			$('#tempat-modal').html(data);
...
//		$.ajax({
//			method: 'POST',
//			url: '<?php //echo base_url('Ecommerce/prosesTambah'); ?>',
//			data: data
//		})
//		.done(function(data) {
//			var out = jQuery.parseJSON(data);
...
//				effect_msg_form();
//			} else {
//				document.getElementById("form-tambah-Ecommerce").reset();
//				$('#tambah-Ecommerce').modal('hide');
//				$('.msg').html(out.msg);
//				effect_msg();
//			}
//		})
